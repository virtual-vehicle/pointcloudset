...
FROM tgoelles/pointcloudset_base:vtgoelles/pointcloudset_base:vtgoelles/pointcloudset_base:vtgoelles/pointcloudset_base:vtgoelles/pointcloudset_base:v0.3.3
